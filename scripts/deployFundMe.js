...
async function main() {
    ...
    console.log("contract deploying  2.。。。。")
    ...
    const fundTx = await fundMe.fund({value: ethers.parseEther("0.00001")})
    await fundTx.wait()

    console.log(`2 accounts。。。 are ${firstAccount} and ${secondAccount}`)
